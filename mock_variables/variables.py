...
# File paths
# ================================================================
DATAFRAME_PATH = "mock_data/df.csv"
FEATURES_PATH = "mock_data/features.json"
...
EXPOSURES = {
    ...
    # ---------------- TIMING ----------------
    "hours_to_sleep_target_day": {"cutoff": None, "method": "median"},
    "eating_window_h_target_day": {"cutoff": None, "method": "median"},
}
